...
if (typeof gdjs.evtsExt__MultitouchJoystick__SetJoystickForce !== "undefined") {
  gdjs.evtsExt__MultitouchJoystick__SetJoystickForce.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__MultitouchJoystick__SetJoystickForce = {};


gdjs.evtsExt__MultitouchJoystick__SetJoystickForce.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__SetJoystickForce.func = function(runtimeScene, ControllerIdentifier, JoystickIdentifier, Value, parentEventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__SetJoystickForce.eventsList0(runtimeScene, eventsFunctionContext);

return;
}

gdjs.evtsExt__MultitouchJoystick__SetJoystickForce.registeredGdjsCallbacks = [];