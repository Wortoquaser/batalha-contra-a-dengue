...
if (typeof gdjs.evtsExt__MultitouchJoystick__IsButtonReleased !== "undefined") {
  gdjs.evtsExt__MultitouchJoystick__IsButtonReleased.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__MultitouchJoystick__IsButtonReleased = {};


gdjs.evtsExt__MultitouchJoystick__IsButtonReleased.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__IsButtonReleased.func = function(runtimeScene, ControllerIdentifier, Button, parentEventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__IsButtonReleased.eventsList0(runtimeScene, eventsFunctionContext);

return !!eventsFunctionContext.returnValue;
}

gdjs.evtsExt__MultitouchJoystick__IsButtonReleased.registeredGdjsCallbacks = [];