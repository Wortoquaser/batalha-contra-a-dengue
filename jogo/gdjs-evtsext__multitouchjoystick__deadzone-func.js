...
if (typeof gdjs.evtsExt__MultitouchJoystick__DeadZone !== "undefined") {
  gdjs.evtsExt__MultitouchJoystick__DeadZone.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__MultitouchJoystick__DeadZone = {};


gdjs.evtsExt__MultitouchJoystick__DeadZone.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__DeadZone.func = function(runtimeScene, ControllerIdentifier, JoystickIdentifier, parentEventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__DeadZone.eventsList0(runtimeScene, eventsFunctionContext);

return Number(eventsFunctionContext.returnValue) || 0;
}

gdjs.evtsExt__MultitouchJoystick__DeadZone.registeredGdjsCallbacks = [];