...
if (typeof gdjs.evtsExt__MultitouchJoystick__JoystickAngle !== "undefined") {
  gdjs.evtsExt__MultitouchJoystick__JoystickAngle.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__MultitouchJoystick__JoystickAngle = {};


gdjs.evtsExt__MultitouchJoystick__JoystickAngle.eventsList0 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__JoystickAngle.func = function(runtimeScene, ControllerIdentifier, JoystickIdentifier, parentEventsFunctionContext) {
...
gdjs.evtsExt__MultitouchJoystick__JoystickAngle.eventsList0(runtimeScene, eventsFunctionContext);

return Number(eventsFunctionContext.returnValue) || 0;
}

gdjs.evtsExt__MultitouchJoystick__JoystickAngle.registeredGdjsCallbacks = [];